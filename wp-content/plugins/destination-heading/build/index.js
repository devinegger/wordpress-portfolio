...
function Edit(props) {
  ...
  }, "to")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "cities"
  }, "- -")));
}
 ...
 * @see https://developer.wordpress.org/block-editor/reference-guides/block-api/block-registration/
 */
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)("create-block/destination-heading", {
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"create-block/destination-heading","version":"0.1.0","title":"Destination Heading","category":"widgets","icon":"admin-comments","description":"A two part heading that is composed of an editable heading witha >> icon and then a second heading that is predefined and animated","attributes":{"heading":{"type":"string","selector":"destination-heading-editable"},"destination":{"type":"string"}},"supports":{"html":false},"textdomain":"destination-heading","viewScript":"file:script.js","editorScript":"file:index.js","editorStyle":"file:index.css","style":"file:style-index.css"}');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkdestination_heading"] = self["webpackChunkdestination_heading"] || [];
